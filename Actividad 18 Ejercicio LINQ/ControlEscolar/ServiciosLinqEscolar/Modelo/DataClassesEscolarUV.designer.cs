...
namespace ServiciosLinqEscolar.Modelo
{
    ...
    partial void Deleteusuario(usuario instance);
        ...
        internal void DeleteDatabase(usuario usuarioDelet)
        {
    ...
    partial void OnidCarreraChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="carrera_alumno", Storage="_carrera", ThisKey="idCarrera", OtherKey="idCarrera", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void OnidFacultadChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="facultad_carrera", Storage="_facultad", ThisKey="idFacultad", OtherKey="idFacultad", IsForeignKey=true, DeleteRule="CASCADE")]
